...
date1='05162025' # Set this for saving today's date. Usually date1=today's date
date2='05162025' # Set alternative date for re-running previous results
rerun = False    # indicate again whether you are re-running previous results
#
dirfin='/glade/derecho/scratch/ito/ML4BGC_results/'

print(f'-----------------------------------------------')
print(f' Machine Learning For BioGeoChemistry (ML4BGC) ')
...
ds=xr.open_dataset(dirin+var[0]+fosd+'1965-2020'+'.nc')
Z=ds.depth.to_numpy()
Nz=np.size(Z)
...
if selection[2] == '1':
    ...
    print('error - incorrect O2 data type')
#
doa1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/pho0_{bname0}_1x1_47lev.npy')
dta1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/t0_{bname0}_1x1_47lev.npy')
dsa1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/s0_{bname0}_1x1_47lev.npy')
xx1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/lon0_{bname0}_1x1_47lev.npy')
yy1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/lat0_{bname0}_1x1_47lev.npy')
zz1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/depth0_{bname0}_1x1_47lev.npy')
tt1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/time0_{bname0}_1x1_47lev.npy')
tc1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/month0_{bname0}_1x1_47lev.npy')
dsga1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/sigma0_{bname0}_1x1_47lev.npy')
dn2a1 = np.load(f'/glade/campaign/univ/ugit0034/PO4/input/N20_{bname0}_1x1_47lev.npy')
